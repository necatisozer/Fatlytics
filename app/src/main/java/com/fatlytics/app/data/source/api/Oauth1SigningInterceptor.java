...
public final class Oauth1SigningInterceptor implements Interceptor {
    ...
    private Oauth1SigningInterceptor(String consumerKey,
    ...
    public Request signRequest(Request request) throws IOException {
        ...
        String oauthTimestamp = String.valueOf(calendar.getTimeInMillis() / 1000);
        ...
        if (requestBody != null) requestBody.writeTo(body);
        ...
        HttpUrl newUrl = url.newBuilder()
                .addQueryParameter(OAUTH_CONSUMER_KEY, consumerKeyValue)
                .addQueryParameter(OAUTH_NONCE, oauthNonce)
                .addQueryParameter(OAUTH_SIGNATURE, signature)
                .addQueryParameter(OAUTH_SIGNATURE_METHOD, OAUTH_SIGNATURE_METHOD_VALUE)
                .addQueryParameter(OAUTH_TIMESTAMP, oauthTimestamp)
                .addQueryParameter(OAUTH_ACCESS_TOKEN, accessTokenValue)
    ...
    public static final class Builder {
        ...
        public Builder calendar(Calendar calendar) {
            if (calendar == null) throw new NullPointerException("clock == null");
            this.calendar = calendar;
            return this;
        }
        ...
        public Oauth1SigningInterceptor build() {
            ...
            return new Oauth1SigningInterceptor(consumerKey,
                    consumerSecret,
                    accessToken,
                    accessSecret,
                    random,
